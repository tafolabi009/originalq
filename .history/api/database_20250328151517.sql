-- Add verification_status column to teacher_profiles table
ALTER TABLE teacher_profiles ADD COLUMN verification_status ENUM('pending', 'verified', 'rejected') NOT NULL DEFAULT 'pending';

-- Add verification_date column to teacher_profiles table
ALTER TABLE teacher_profiles ADD COLUMN verification_date DATETIME NULL;

-- Add verification_notes column to teacher_profiles table
ALTER TABLE teacher_profiles ADD COLUMN verification_notes TEXT NULL;
